...
public class CreateInviteOnExistingLocation extends TestSuiteBase{
	{
	...
	public void checkTestSkip(){
	  ...
	  @Test(dataProvider="getTestData")
       public void createInviteOnExistingLocation(
                String testCaseName,
	            String browserType,
	            String url,
	            String username,
		...
		String testName="CreateInviteOnExistingLocation"+" ("+testCaseName+")";
      ...
      Log.info("==================================================================================================================================================");	  
	     ...
	     navigate(url);
		 getScreen(document, fos, "loginPage");
		 ...
		 waitForWebElement("locations_icon_inviteGuest_xpath", 30, 1);
		 click("locations_icon_inviteGuest_xpath");
		 waitForWebElement("locations_txtbx_guestEmail_xpath", 30,1);
		 input("locations_txtbx_guestEmail_xpath", email);
		 input("locations_txtbx_firstName_xpath", first_name);
		 input("locations_txtbx_lastName_xpath", last_name);
		 input("locations_txtbx_company_xpath", company);
		 click("locations_btn_saveInvite_xpath");
		 waitForTextToBeDisplayed("commanPage_txt_notificationMsg_xpath", "Invitation created", 30);
		 click("locations_ckbx_guestList_xpath");
		 click("locations_icon_deleteGuest_xpath");
		 waitForWebElement("locations_btn_confirmDelete_xpath", 30, 1);
		 click("locations_btn_confirmDelete_xpath");
	}
