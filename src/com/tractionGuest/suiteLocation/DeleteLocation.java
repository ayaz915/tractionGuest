...
public class DeleteLocation extends TestSuiteBase{
	{
	...
	public void checkTestSkip(){
	  ...
	  @Test(dataProvider="getTestData")
       public void deleteLocation(
	            ...
	            String username,
				String password,
				String locationNameToBeDeleted			
							) throws Exception{
		...
		String testName="DeleteLocation"+" ("+testCaseName+")";
      ...
      Log.info("==================================================================================================================================================");	  
		 ...
		 String xpath=createRuntimeXpath("locations_lnk_locationNamePart1_xpath", "locations_lnk_locationNamePart2_xpath", locationNameToBeDeleted);
		 ...
		 waitForTextToBeDisplayed("commanPage_txt_notificationMsg_xpath", "Location Deleted", 30);
